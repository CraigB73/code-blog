"""
Django settings for code_blog project.
...
MIDDLEWARE = [
    ...
    'allauth.account.middleware.AccountMiddleware', #  Add from allauth
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.request', # add from documentation
            ],
        },
    },
]
...
#Djano default sqlite3 DATABASE
# DATABASES = {
#     'default': {
